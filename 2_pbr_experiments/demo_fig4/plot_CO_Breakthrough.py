...
ax.plot([0,2000], [0,0], lw = 1.0,color = 'black', label = '__nolegend__')
...
plt.tight_layout()
plt.savefig(os.path.join('plots', '' + '24052023_Demo_930C_CO_breakthrough.png'), dpi = 400, bbox_inches='tight')
plt.savefig(os.path.join('plots', '24052023_Demo_930C_dataset_CO_breakthrough.pdf'), bbox_inches='tight')
plt.show()
